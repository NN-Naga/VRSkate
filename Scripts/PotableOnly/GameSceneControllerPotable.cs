...
public class GameSceneController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            PathControlPotable.RapInfo = 0;
            PathControlPotable.TimeInfo = 0f;
            PathControlPotable.DistanceInfo = 0f;
    ...
    void Update()
    {
        int Rap = PathControlPotable.RapInfo;
    ...
    void GameResult()
    {
        float totalTime = PathControlPotable.TimeInfo;
